<template>
  <li class="logoutBtn" @click.stop="logoutlogoutHandler">
    <ul class="logoutUI" ref="logoutUINode">
      <li class="close"></li>
      <li class="restart">
        <figure class="roleList">
          ...
          <img src="../assets/magician/logo_magician.png" class="magician" alt="magician-logo" />
        </figure>
      </li>
      <li class="exit"></li>
      <li class="cancel"></li>
...
function logoutlogoutHandler(e) {
